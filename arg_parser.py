...
parser.add_argument('-workflow', dest='workflow_file', help="Run a workflow from a YML file containing multiple mappings")
parser.add_argument('-mapping', dest='mapping_short', help="A mapping shortcut, exple: 'DBPRD.SC.TABLE1:STGDEV.DBDEV.SS.TABLE2'")
